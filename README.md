...
目前「霞鶩晰黑」包含 IICore 所收錄的 9810 個常用漢字，以及原始授權字型「IPAex ゴシック」所包含的 JIS 第 1～4 級別漢字，[「jf 7000 當務字集」](https://justfont.com/jf7000)基本包、臺灣命名、粵語包所收字，和[《常用香港外字表》](https://github.com/ichitenfont/suppchara)收錄的 A～C、1～5、ㄅ級外字等。自 0.500 版本起，補全 BIG5 範圍內的所有漢字。不考慮與「霞鶩新晰黑」所收字彙看齊。另提供 Windows 內置「細明體」度量兼容版本[「晰黑體 B5」](https://github.com/lxgw/XiZhiB5)，採用 MN 字形、BIG5-Eten 字符集。
